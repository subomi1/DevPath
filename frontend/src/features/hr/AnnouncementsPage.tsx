        ...
        {isLoading ? (
          ...
          <div className="bg-surface border border-border rounded-2xl p-10 text-center shadow-xs flex-1 flex flex-col items-center justify-center">
            ...
            <p className="text-sm text-ink-muted max-w-sm mx-auto">
              There are no announcements in this category yet. You can create a
              new one using the button above.
            </p>
          </div>
        ) : (
                ...
                >
                  ...
                  >
                    <div className="shrink-0 mt-0.5 relative">
                      <div
                        className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold text-sm ${isUnread ? "bg-primary text-white" : "bg-canvas border border-border text-ink-muted"}`}
                      >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-4 mb-1">
                        <h3
                          className={`text-sm sm:text-base truncate ${isUnread ? "font-bold text-ink" : "font-semibold text-ink/90"}`}
                        >
                          {a.title}
                        </h3>
              ...
              <div className="pt-4 border-t border-border mt-auto">
                <div className="bg-primary/5 border border-primary/20 rounded-xl p-3.5 mb-4 flex items-start gap-3">
                  ...
                  <p className="text-xs text-ink/80 leading-relaxed">
                    This announcement will be published exclusively to members
